    ...
    return MaterialApp(
      ...
      home: Scaffold(
                    ...
                    Container(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        value: (drawingState.totalLineNumber == 0
                                ? 0.0
                                : (drawingState.drawnLineNumber /
                                        drawingState.totalLineNumber) *
                                    100) /
                            100,
                        valueColor: AlwaysStoppedAnimation<Color>(
                            Colors.blue), // Change color if needed
                      ),
                    ),
                    Positioned(
                      right: 0,
                      child: Container(
                        ...
                        child: Text(
                          '${(drawingState.totalLineNumber == 0 ? 0.0 : (drawingState.drawnLineNumber / drawingState.totalLineNumber) * 100).toInt()}%', // Display the percentage value
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: drawingState.isDrawing
              ? null
              : () {
                  setState(() {
          ...
          backgroundColor: (drawingState.isDrawing ||
                  (_image == null && !drawingState.isDrawing))
              ? Color(0xFF4F4F4F)
              : Color(0xFF33C2FF),
          elevation: (drawingState.isDrawing ||
                  (_image == null && !drawingState.isDrawing))
              ? 0
              : 6,
        ),
